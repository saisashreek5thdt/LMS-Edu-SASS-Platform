...
const teamData = [
  {
    ...
    teamInfo: [
      { name: "John Doe", designation: "Lead Developer", modules: "23" },
    ],
  },
  {
    image: "https://dummyimage.com/200x100",
    teamInfo: [
      { name: "Jane Smith", designation: "UI/UX Designer", modules: "15" },
    ],
  },
  {
    image: "https://dummyimage.com/200x100",
    teamInfo: [
      { name: "Alice Johnson", designation: "Product Manager", modules: "30" },
    ],
  },
  {
    image: "https://dummyimage.com/200x100",
    teamInfo: [
      { name: "Mike Brown", designation: "QA Engineer", modules: "12" },
    ],
  },
  {
    image: "https://dummyimage.com/200x100",
    teamInfo: [
      { name: "Chris Evans", designation: "DevOps Engineer", modules: "10" },
    ],
  },
  {
    image: "https://dummyimage.com/200x100",
    teamInfo: [
      { name: "Sara Wilson", designation: "Scrum Master", modules: "8" },
    ],
  },
  {
    image: "https://dummyimage.com/200x100",
...
export default function TeamCard() {
  ...
  return (
    <div className="mt-16">
      ...
      <h1 className="text-center text-3xl font-bold text-gray-800 mb-14"></h1>
